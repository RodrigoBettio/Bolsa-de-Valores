...
public class Bolsa_Valores {
    public static void main(String[] args) {
        ...
        Corretora corretora1 = new Corretora("Corretora1", 0.1f);
        Corretora corretora2 = new Corretora("Corretora2", 0.15f);

        Acao acao1 = new Acao("AAPL", "Apple Inc.", 20, 2);
        Acao acao2 = new Acao("GOOGL", "Alphabet Inc.", 12, 1.2);
        FII fii1 = new FII("FII123", "FII Exemplo");

        Carteira carteira1 = new Carteira("Carteira1", investidor1);
        carteira1.adicionarAtivo(acao1);
        carteira1.adicionarAtivo(acao2);

        Carteira carteira2 = new Carteira("Carteira2", investidor2);
        carteira2.adicionarAtivo(acao1);
        carteira2.adicionarAtivo(fii1);

        investidor1.adicionarCarteira(carteira1);
        investidor2.adicionarCarteira(carteira2);
